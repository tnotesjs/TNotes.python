...
- [1. 本节内容](#1-本节内容)
- [2. 模块的导入方式有哪些？](#2-模块的导入方式有哪些)
- [3. 模块搜索路径是怎样的？](#3-模块搜索路径是怎样的)
- [4. if **name** == '**main**' 有什么作用？](#4-if-name--main-有什么作用)
- [5. 如何创建和组织包？](#5-如何创建和组织包)
- [6. 相对导入和绝对导入有什么区别？](#6-相对导入和绝对导入有什么区别)
- [7. 有哪些常用的内置模块？](#7-有哪些常用的内置模块)
