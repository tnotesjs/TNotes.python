...
- [1. 本节内容](#1-本节内容)
- [2. 如何定义和调用函数？](#2-如何定义和调用函数)
- [3. 函数参数有哪些类型？](#3-函数参数有哪些类型)
- [4. return 语句是如何工作的？](#4-return-语句是如何工作的)
- [5. 变量的作用域是怎样的？](#5-变量的作用域是怎样的)
- [6. 什么是文档字符串 docstring？](#6-什么是文档字符串-docstring)
