...
- [2. 评价](#2-评价)
- [3. 什么是递归函数？](#3-什么是递归函数)
- [4. 什么是匿名函数 lambda？](#4-什么是匿名函数-lambda)
- [5. 高阶函数 map、filter、reduce 怎么用？](#5-高阶函数-mapfilterreduce-怎么用)
- [6. 什么是闭包？](#6-什么是闭包)
- [7. 装饰器的原理与实现是怎样的？](#7-装饰器的原理与实现是怎样的)
- [8. 什么是偏函数 functools.partial？](#8-什么是偏函数-functoolspartial)
