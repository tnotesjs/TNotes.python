...
- [1. 本节内容](#1-本节内容)
- [2. Python 有哪些算术运算符？](#2-python-有哪些算术运算符)
- [3. 比较运算符怎么用？](#3-比较运算符怎么用)
- [4. 赋值运算符有哪些形式？](#4-赋值运算符有哪些形式)
- [5. 逻辑运算符如何使用？](#5-逻辑运算符如何使用)
- [6. 位运算符的作用是什么？](#6-位运算符的作用是什么)
- [7. 成员运算符 in 和 not in 怎么用？](#7-成员运算符-in-和-not-in-怎么用)
- [8. 身份运算符 is 和 is not 有什么作用？](#8-身份运算符-is-和-is-not-有什么作用)
- [9. 运算符的优先级是怎样的？](#9-运算符的优先级是怎样的)
