...
- [1. 本节内容](#1-本节内容)
- [2. **str** 和 **repr** 有什么区别？](#2-str-和-repr-有什么区别)
- [3. 如何重载比较运算符？](#3-如何重载比较运算符)
- [4. 如何重载算术运算符？](#4-如何重载算术运算符)
- [5. 如何让对象支持容器操作？](#5-如何让对象支持容器操作)
- [6. 什么是上下文管理器？](#6-什么是上下文管理器)
- [7. 什么是可调用对象 **call**？](#7-什么是可调用对象-call)
