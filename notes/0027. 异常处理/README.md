...
- [1. 本节内容](#1-本节内容)
- [2. 什么是异常？常见的内置异常有哪些？](#2-什么是异常常见的内置异常有哪些)
- [3. try-except-else-finally 结构怎么用？](#3-try-except-else-finally-结构怎么用)
- [4. 如何自定义异常？](#4-如何自定义异常)
- [5. raise 和异常链是什么？](#5-raise-和异常链是什么)
- [6. 如何使用断言 assert？](#6-如何使用断言-assert)
...
## 3. try-except-else-finally 结构怎么用？
