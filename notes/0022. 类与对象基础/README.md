...
- [1. 本节内容](#1-本节内容)
- [2. 评价](#2-评价)
- [3. 什么是面向对象编程思想？](#3-什么是面向对象编程思想)
- [4. 如何定义类和创建实例？](#4-如何定义类和创建实例)
- [5. 实例属性和类属性有什么区别？](#5-实例属性和类属性有什么区别)
- [6. 实例方法与 self 参数是什么？](#6-实例方法与-self-参数是什么)
- [7. 构造方法 **init** 怎么用？](#7-构造方法-init-怎么用)
- [8. 析构方法 **del** 是什么？](#8-析构方法-del-是什么)
