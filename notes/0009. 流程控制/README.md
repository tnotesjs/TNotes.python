...
- [1. 本节内容](#1-本节内容)
- [2. if/elif/else 条件语句怎么用？](#2-ifelifelse-条件语句怎么用)
- [3. 什么是条件表达式（三元运算符）？](#3-什么是条件表达式三元运算符)
- [4. while 循环如何使用？](#4-while-循环如何使用)
- [5. for 循环如何使用？](#5-for-循环如何使用)
- [6. range() 函数有哪些用法？](#6-range-函数有哪些用法)
- [7. break、continue、pass 语句分别有什么作用？](#7-breakcontinuepass-语句分别有什么作用)
- [8. 循环的 else 子句是什么？](#8-循环的-else-子句是什么)
...
## 7. break、continue、pass 语句分别有什么作用？
