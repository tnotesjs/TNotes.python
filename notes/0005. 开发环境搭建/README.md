...
- [1. 本节内容](#1-本节内容)
- [2. 如何选择适合的编辑器或 IDE？](#2-如何选择适合的编辑器或-ide)
- [3. 什么是虚拟环境？如何创建和管理？](#3-什么是虚拟环境如何创建和管理)
- [4. 如何使用 pip 管理包？](#4-如何使用-pip-管理包)
- [5. 如何使用 requirements.txt 管理项目依赖？](#5-如何使用-requirementstxt-管理项目依赖)
...
## 5. 如何使用 requirements.txt 管理项目依赖？
