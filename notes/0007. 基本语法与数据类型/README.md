...
- [1. 本节内容](#1-本节内容)
- [2. Python 中的标识符和关键字有哪些规则？](#2-python-中的标识符和关键字有哪些规则)
- [3. 变量和常量在 Python 中是如何工作的？](#3-变量和常量在-python-中是如何工作的)
- [4. Python 中如何写注释？](#4-python-中如何写注释)
- [5. 为什么缩进被称为 Python 的灵魂？](#5-为什么缩进被称为-python-的灵魂)
- [6. Python 有哪些基本数据类型？](#6-python-有哪些基本数据类型)
- [7. 字符串如何定义与转义？](#7-字符串如何定义与转义)
