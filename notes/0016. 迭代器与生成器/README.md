...
- [1. 本节内容](#1-本节内容)
- [2. 什么是可迭代对象和迭代器？](#2-什么是可迭代对象和迭代器)
- [3. 如何实现一个自定义迭代器？](#3-如何实现一个自定义迭代器)
- [4. 什么是生成器函数？](#4-什么是生成器函数)
- [5. 什么是生成器表达式？](#5-什么是生成器表达式)
- [6. itertools 模块有哪些常用工具？](#6-itertools-模块有哪些常用工具)
